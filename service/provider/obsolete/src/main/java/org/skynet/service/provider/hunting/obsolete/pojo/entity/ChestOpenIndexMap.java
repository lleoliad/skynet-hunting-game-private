...
public class ChestOpenIndexMap implements Serializable {
    ...
    HashMap<String, Integer> gunRewardIndexMap = null;

    @ApiModelProperty(value = "种枪卡库抽取次数")
    Map<Integer, Integer> gunLibraryDrawCountMap = null;

    @ApiModelProperty(value = "子弹奖励内容index")
    HashMap<String, Integer> bulletRewardIndexMap = null;

    @ApiModelProperty(value = "金币和钻石奖励内容index")
    Integer coinAndDiamondRewardIndex;
}
