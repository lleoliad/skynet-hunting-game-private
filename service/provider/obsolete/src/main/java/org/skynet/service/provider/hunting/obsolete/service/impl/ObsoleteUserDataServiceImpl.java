...
@Service
@Slf4j
public class ObsoleteUserDataServiceImpl implements ObsoleteUserDataService {
    ...
    public UserData createDefaultUserData(Long userId, String uuid, String gameVersion) {
        ...
        ChestOpenIndexMap chestOpenIndexMap = new ChestOpenIndexMap();
        ...
        ServerOnly serverOnly = new ServerOnly();
        serverOnly.setAbTestGroup(ABTestGroup.A);
        serverOnly.setPrivateKey(NanoIdUtils.randomNanoId(24));
        serverOnly.setChestOpenIndexMap(chestOpenIndexMap);
        ...
        userData.setName(createGuestName(""));
        userData.setUuid(uuid);
        userData.setCoin(GameConfig.defaultCoinAmount);
        userData.setDiamond(GameConfig.defaultDiamondAmount);
        userData.setTutorialData(tutorialData);
        userData.setEquippedGunId(GameConfig.defaultGunID);
        userData.setEquippedBulletId(GameConfig.defaultBulletID);
        userData.setFreeChestsData(freeChestDataList);
        userData.setLinkedAuthProviderData(linkedAuthProviderData);
        ...
        userData.setLuckyWheelV2Data(createDefaultLuckyWheelV2Data(gameVersion));
        userData.setAdvertisementData(createDefaultPlayerAdvertisementData());
        userData.setVipData(createDefaultPlayerVipData());
        userData.setVipV2Data(createDefaultPlayerVipV2Data());
        userData.setVipV3Data(createDefaultPlayerVipV3Data());
    ...
    public UserData upgradeUser(UserData userData, String gameVersion) {
        ...
        ChestOpenIndexMap map = new ChestOpenIndexMap();//new ChestOpenIndexMap(new HashMap<>(), new HashMap<>(), new HashMap<>(), 0);
