...
@ApiModel(value = "VipV2Config对象", description = "VipV2设置")
public class VipV2Config {
    ...
    public static final String vipProductName = "hs_vip_v2";

    @ApiModelProperty("每日钻石奖励")
    public static final Integer vipDailyDiamondRewardCount = 150;

    @ApiModelProperty("购买钻石奖励")
    public static final Integer vipPurchaseDiamondRewardCount = 1000;

    @ApiModelProperty("每日领取子弹id")
    public static final Integer vipDailyRewardBulletId = 3;

    @ApiModelProperty("每日领取子弹数量")
    public static final Integer vipDailyRewardBulletCount = 8;
    ...
    public static final String svipProductName = "hs_svip_v2";
    ...
    public static final Integer svipDailyRewardOrangeGunCount = 38;
}
